...
def build_vocabulary_from_training_set(train_path, tree_depth=3, tree_k=10):
    """从训练集构建词汇树"""
    ...
    return im_features, image_paths, idf, numWords, voc_tree, weighted_inverted_index
...
def main():
    ...
    build_vocabulary_from_training_set(train_path)
